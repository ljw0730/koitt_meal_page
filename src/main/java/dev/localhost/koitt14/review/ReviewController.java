...
public class ReviewController {
  ...
  public String reviewWrite(HttpServletRequest request, Model model) {
	  ...
	  String result= reviewService.reviewWrite(request, model);
	  String uri = "";
	  switch (result) {
      case "pass":
        uri = "/review/reviewWriteView";
        break;
      case "limit":
  ...
  public String reviewModify(HttpServletRequest request, Model model) {
	  ...
	  String result=reviewService.reviewModify(request,model);
	  String uri = "";
	  switch (result) {
      case "pass":
        uri = "/review/reviewModifyView";
        break;
      case "limit":
        uri = "review/reviewWriteLimit";
        break;
