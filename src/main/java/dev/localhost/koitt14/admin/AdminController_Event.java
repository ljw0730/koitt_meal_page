...
public class AdminController_Event {
  ...
  public String eventWrite(HttpServletRequest request, RedirectAttributes redirect) {
	  ...
	  String result = eventService.eventWrite(request, redirect);
	  
	  String uri = "";
	  
	  switch (result) {
	  	case "pass" :
	  		uri = "redirect:/admin/event/event"; 
	  		break;
	  	case "limit" :
	  		uri = "event/writeLimit";
	  		break;
	  	default : 
	  		uri = "error/500";
	  }
  ...
  public String eventModify(HttpServletRequest request,
	  ...
	  String result = eventService.eventModify(request, seqKey, redirect);
	  
	  String uri = "";
	  
	  switch (result) {
	  	case "pass" :
	  		uri = "redirect:/admin/event/event/view/" + seqKey + "/" + page;
	  		break;
	  	case "limit" :
	  		uri = "event/writeLimit";
	  		break;
