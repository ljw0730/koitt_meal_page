...
public class AdminController_CustomerNotice {
 ...
 @GetMapping({"admin/customer/notice/search",
  ...
  public String noticeWrite(HttpServletRequest request, RedirectAttributes redirect) {
	  ...
	  String result = customerService.noticeWrite(request, redirect);
	  
	  String uri = "";
	  
	  switch (result) {
	  	case "pass" :
	  		uri = "redirect:/admin/customer/notice"; 
	  		break;
	  	case "limit" :
	  		uri = "customer/writeLimit";
	  		break;
	  	default : 
	  		uri = "error/500";
	  }
  ...
  public String noticeModify(HttpServletRequest request,
	  ...
	  String result = customerService.noticeModify(request, redirect);
	  
	  String uri = "";
	  
	  switch (result) {
	  	case "pass" :
	  		uri = "redirect:/admin/customer/notice/view/" + seqKey + "/" + page; 
	  		break;
	  	case "limit" :
	  		uri = "customer/writeLimit";
	  		break;
