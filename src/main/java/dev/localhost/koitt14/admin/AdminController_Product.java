...
public class AdminController_Product {
	  ...
	  public String productInsert(HttpServletRequest request, Model model) {
		  ...
		  String result=productService.productInsert(request,model);
		  String uri = "";

		    switch (result) {
		      case "pass":
		        uri = "admin/product_insert";
		        break;
		      case "limit":
		        uri = "review/reviewWriteLimit";
		        break;
		      default:
		        uri = "error/500";
		    }
	  ...
	  public String productModify(HttpServletRequest request, Model model) {
		  ...
		  String result=productService.productModify(request,model);
		  String uri = "";

		    switch (result) {
		      case "pass":
		        uri = "admin/product_modify";
		        break;
		      case "limit":
		        uri = "review/reviewWriteLimit";
		        break;
